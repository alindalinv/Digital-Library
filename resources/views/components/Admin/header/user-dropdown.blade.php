<div class="relative" x-data="{
    ...
    <!-- User Button -->
    <button class="flex items-center text-gray-700" @click.prevent="toggleDropdown()" type="button">
    ...
    <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-100"
        ...
        <div class="mt-3 border-t border-gray-200 pt-3 dark:border-gray-800">
            <form method="POST" action="{{ route('admin.logout') }}">
                ...
                <button type="submit" class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium
