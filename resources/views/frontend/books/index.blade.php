<x-app-layout>
    ...
    @push('css')
        <style>
            .catalog-hero {
                background: linear-gradient(120deg, #eef5ff 0%, #f8fbff 55%, #fff 100%);
            }
    ...
    <div class="py-5">
        <div class="container">
            <section class="catalog-hero rounded-4 p-4 p-lg-5 mb-4">
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        ...
                        <p class="text-secondary mb-0">Search the collection, narrow by category, and sort the shelves
                            your way.</p>
                    </div>
                    <div class="col-lg-6">
                        <form id="book-filters" method="GET" action="{{ route('books.index') }}"
                            class="catalog-filter bg-white rounded-3 p-3">
                            <div class="row g-2">
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="book-search" type="search" name="search" value="{{ $search }}"
                                            placeholder="Title, ISBN, or author" class="form-control border-start-0"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input id="book-featured" name="featured" value="1" type="checkbox"
                                            class="form-check-input" @checked($featured)>
                                        <label for="book-featured"
                                            class="form-check-label d-inline-flex align-items-center gap-1 text-warning-emphasis">
            ...
            <div id="books-summary" class="d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="small text-secondary">{{ $books->firstItem() ?? 0 }}-{{ $books->lastItem() ?? 0 }} of
                    {{ $books->total() }}</span>
            </div>
