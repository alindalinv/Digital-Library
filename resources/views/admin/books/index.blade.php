...
{{-- =========================================================
        ...
        ========================================================== --}}
<div
    class="my-5 flex flex-col gap-4 rounded-xl border border-gray-200 bg-gray-50/70 lg:flex-row lg:items-center lg:justify-between dark:border-gray-800 dark:bg-gray-800/30">
    ...
    <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="flex flex-wrap items-center gap-1 rounded-lg bg-white p-1 shadow-sm ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-700"
            ...
            <button type="button" role="tab" data-status="{{ $value }}"
                ...
                class="status-tab rounded-md px-3 py-1.5 text-sm font-medium transition
                {{ $activeStatus === $value ? 'bg-blue-50 text-blue-700 shadow-sm ring-1 ring-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:ring-blue-500/20'
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const syncUI = () => {
            ...
            statusTabs.forEach((tab) => {
                ...
                tab.classList.toggle('ring-blue-200', isActive);

                tab.classList.toggle('dark:bg-blue-500/10', isActive);
                tab.classList.toggle('dark:text-blue-400', isActive);
                tab.classList.toggle('dark:ring-blue-500/20', isActive);
                ...
                tab.classList.toggle('dark:hover:bg-gray-800', !isActive);
